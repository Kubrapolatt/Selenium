...
public class C01_DependsOnMetods {
  ...
  //  ● Bir class oluşturun: DependsOnTest
    ...
    public void fiyatTesti(){
        //  3.Test : “Nutella” icin arama yapildiysa ilk urunu tiklayin ve fiyatinin    $14.99 oldugunu test edin
         ...
         WebElement ürünFiyatElementi=driver.findElement(By.xpath("//span[@class='a-size-base a-color-price']"));
         String ürünFiyatıString=ürünFiyatElementi.getText();
         String arananFiyat="$14.99";

         Assert.assertTrue(ürünFiyatıString.contains(arananFiyat));
    }
